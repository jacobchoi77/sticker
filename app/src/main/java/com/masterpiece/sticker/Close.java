...
public class Close {
	...
	public Close(Bitmap bitmap, Border border) {
		mBitmap = bitmap;
	...
	public void refresh() {
		mPosition.x = mBorder.getLeft() - getWidth() / 2;
		mPosition.y = mBorder.getTop() - getHeight() / 2;
	...
	public boolean isInClose(float x, float y) {
